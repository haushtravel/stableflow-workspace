...
func handleSendOTP(w http.ResponseWriter, r *http.Request) {
	...
	messageBody := fmt.Sprintf("Tu codigo de verificacion Spree es: %s. Valido por 5 minutos.", code)
	var twilioErr error
...
func chargeWithStripe(token string, amountCents int) (string, error) {
	...
	v.Set("currency", "usd")
	v.Set("source", token)
	v.Set("description", "Spree Budget Preload")
...
func handleCheckout(w http.ResponseWriter, r *http.Request) {
	...
	if !isMarketplace && !authorizedMerchants[req.Merchant] {
		...
		json.NewEncoder(w).Encode(map[string]interface{}{
			"success": false,
			"message": "Comercio no autorizado o no registrado en la plataforma Spree.",
		})
		return
	}
...
var botReplies = map[string]map[string]string{
	"es": {
		...
		"tours":     "<b>🗺️ Reservas y Actividades Civitatis</b><br><br>¡Explora LATAM como un local! A través de nuestra alianza con <b>Civitatis</b>, puedes reservar tours, excursiones y traslados privados directamente con tu saldo de Spree:<br><br>• <b>Flujo asistido:</b> Un bot automatizado de Spree completará los formularios por ti.<br>• <b>Cómo iniciar:</b> Solo escribe <b>'tour'</b> o <b>'civitatis'</b> aquí en el chat, o pulsa el botón del bot en la sección <b>'Mejora tu viaje'</b> y dime en qué ciudad quieres realizar tu actividad (Buenos Aires o Río de Janeiro).",
		"network":   "<b>🌐 ¿Cómo funciona la tecnología de Spree?</b><br><br>Spree combina la estabilidad de los dólares digitales (USDc) con la red financiera local de LATAM:<br><br>• <b>Estabilidad:</b> Tus fondos están resguardados en USDc (equivalentes 1:1 al dólar estadounidense).<br>• <b>Conversión en tiempo real:</b> Al escanear un QR local, el backend convierte y liquida instantáneamente los fondos al comercio en moneda local mediante nuestros rieles de liquidez partners (como Bitso).",
		"limits":    "<b>⚙️ Límites de tu cuenta Spree</b><br><br>Para garantizar la seguridad de tu dinero, aplicamos los siguientes límites por defecto:<br><br>• <b>Límite diario de carga:</b> Hasta <b>$5,000 USDc</b>.<br>• <b>Límite diario de gasto:</b> Hasta <b>$5,000 USDc</b>.<br><br>Si necesitas límites mayores para tu viaje, solicita una ampliación escribiendo <b>'agente'</b> para hablar con soporte técnico.",
		"times":     "<b>⏱️ Tiempos de acreditación en Spree</b><br><br>Conoce cuánto tardan tus operaciones:<br><br>• <b>Cargas de saldo (Fondeo):</b> Inmediata. Los fondos están disponibles al instante tras autorizar el pago.<br>• <b>Pagos con códigos QR (Mercado Pago, MODO, Pix):</b> Inmediata. El comercio recibe su dinero local al instante.<br>• <b>Reembolsos (Retiros a tu tarjeta original):</b> Toma entre <b>2 a 5 días hábiles</b> en verse reflejado debido a los tiempos de liquidación de las redes bancarias internacionales.",
	...
	"en": {
		...
		"tours":     "<b>🗺️ Civitatis Booking Assistant</b><br><br>Explore LATAM like a local! Through our partnership with <b>Civitatis</b>, you can book tours, excursions, and private transfers directly with your Spree balance:<br><br>• <b>Automated Booking:</b> A Spree bot will automatically fill out the booking details for you.<br>• <b>How to start:</b> Type <b>'tour'</b> or <b>'civitatis'</b> here in the chat, or click the bot button in <b>'Improve Your Trip'</b> to start.",
		"network":   "<b>🌐 How does Spree work?</b><br><br>Spree combines digital dollars (USDc) with local financial rails in LATAM:<br><br>• <b>Stability:</b> Your funds are kept in USDc (pegged 1:1 to the US dollar).<br>• <b>Real-time Conversion:</b> When scanning a local QR code, our backend automatically converts and settles the payment in local currency instantly.",
		...
		"default":   "<b>👋 Hello! I am the Spree virtual assistant.</b><br><br>I couldn't quite understand your query. I am here to help you. You can ask me about:<br><br>• <b>'preloads'</b> or <b>'card'</b><br>• <b>'QR payments'</b> or <b>'Pix'</b><br>• <b>'fees'</b> or <b>'costs'</b><br>• <b>'refunds'</b> or <b>'withdraw'</b><br>• <b>'eSIM'</b>, <b>'insurance'</b> or <b>'tours'</b><br>• Write <b>'agent'</b> if you need human support.",
	},
	"it": {
		"preload":   "<b>💳 Come ricaricare la tua Spree wallet?</b><br><br>Per aggiungere fondi, vai alla scheda <b>'Carica'</b> nel menu in basso. Puoi utilizzare:<br><br>• <b>Apple Pay / Google Pay:</b> Accredito istantaneo.<br>• <b>Carte di Credito / Debito:</b> Visa, Mastercard e altre carte internazionali.<br><br><i>Nota:</i> Applichiamo una commissione dell'<b>1%</b>. I fondi vengono accreditati istantaneamente in <b>USDc</b> (dollari digitali).",
		...
		"qr":        "<b>📲 Pagamenti QR in LATAM</b><br><br>Spree ti consente di pagare scansionando i codici QR locali:<br><br>• <b>In Argentina 🇦🇷:</b> Supportiamo <b>Mercado Pago</b> e <b>MODO</b>. Paghi in USDc e il negozio riceve ARS istantaneamente.<br>• <b>In Brasile 🇧🇷:</b> Supportiamo Pix. Paghi in USDc e il negozio riceve BRL istantaneamente.<br><br><i>Commissioni:</i> Applichiamo il <b>3%</b> di servizio e <b>$0.10 USDc</b> di costo transazione.",
		"fees":      "<b>📊 Tariffe Spree</b><br><br>Le nostre commissioni sono semplici e trasparenti:<br><br>• <b>Ricarica:</b> 1% del totale.<br>• <b>Pagamento QR:</b> 3% di servizio + $0.10 USDc costo transazione.<br>• <b>Rimborso (ritiro):</b> 1.5% del totale.<br><br>Non addebitiamo costi di gestione conto o inattività.",
		"esim":      "<b>📶 eSIM Spree</b><br><br>Rimani conneso per tutto il viaggio senza costi di roaming:<br><br>• <b>La tua prima eSIM è in regalo!</b> Richiedila nella scheda <b>'Migliora il tuo Viaggio'</b>.<br>• <b>Copertura:</b> Dati ad alta velocità in Argentina e Brasile.<br>• <b>Successive:</b> Ogni pacchetto da 10GB costa <b>$15.00 USDc</b>.",
		...
		"tours":     "<b>🗺️ Assistente Civitatis</b><br><br>Prenota tour e trasferimenti direttamente con il tuo saldo Spree:<br><br>• <b>Prenotazione automatica:</b> Un bot si occuperà di compilare i dati per te.<br>• <b>Come iniziare:</b> Scrivi <b>'tour'</b> o <b>'civitatis'</b> in chat, oppure clicca sul pulsante del bot nella scheda <b>'Migliora il tuo Viaggio'</b>.",
		"network":   "<b>🌐 Come funziona Spree?</b><br><br>Spree unisce USDc con i circuiti bancari locali in LATAM per conversioni e pagamenti QR istantanei al miglior tasso di cambio.",
	...
	"fr": {
		...
		"qr":        "<b>📲 Paiements par code QR en LATAM</b><br><br>Spree vous permet de payer en scannant des codes QR locaux chez les commerçants :<br><br>• <b>En Argentine 🇦🇷 :</b> Scannez les codes <b>Mercado Pago</b> ou <b>MODO</b>. Payez en USDc, le marchand reçoit des ARS immédiatement.<br>• <b>Au Brésil 🇧🇷 :</b> Scannez les codes Pix. Payez en USDc, le marchand reçoit des BRL immédiatement.<br><br><i>Frais :</i> Commission de service de <b>3%</b> + <b>$0.10 USDc</b> de frais de transaction.",
		"fees":      "<b>📊 Tarification Spree</b><br><br>Nos frais sont simples et transparents :<br><br>• <b>Chargement :</b> 1% du montant.<br>• <b>Paiments QR :</b> 3% de service + $0.10 USDc par transaction.<br>• <b>Remboursements :</b> 1.5% du montant.<br><br>Aucun frais de tenue de compte ou d'inactivité.",
		"esim":      "<b>📶 eSIM Régionale Spree</b><br><br>Restez connecté tout au long de votre voyage sans frais de roaming :<br><br>• <b>Votre première eSIM est offerte !</b> Demandez-la dans l'onglet <b>'Améliorez votre Voyage'</b>.<br>• <b>Couverture :</b> Données haut débit en Argentine et au Brésil.<br>• <b>Suivantes :</b> Chaque recharge de 10Go coûte <b>$15.00 USDc</b>.",
		...
		"tours":     "<b>🗺️ Assistant de Réservation Civitatis</b><br><br>Réservez des excursions et des transferts directement avec votre solde Spree :<br><br>• <b>Réservation automatisée :</b> Un bot Spree s'occupe de remplir les formulaires pour vous.<br>• <b>Comment démarrer :</b> Écrivez <b>'tour'</b> ou <b>'civitatis'</b> dans le chat, ou cliquez sur le bouton de l'assistant dans l'onglet <b>'Améliorez votre Voyage'</b>.",
		"network":   "<b>🌐 Comment fonctionne Spree ?</b><br><br>Spree convertit vos dollars digitaux (USDc) en monnaie locale en temps réel lors du paiement par QR pour régler le commerçant instantanément.",
		...
		"times":     "<b>⏱️ Délais d'accréditation Spree</b><br><br>Voici les délais de vos opérations :<br><br>• <b>Chargements :</b> Instantanés. Les fonds sont disponibles immédiatement.<br>• <b>Paiements QR :</b> Instantanés. Le commerçant reçoit son argent immédiatement.<br>• <b>Remboursements :</b> Prennent <b>2 à 5 jours ouvrés</b> pour apparaître sur votre carte d'origine.",
	...
	"de": {
		...
		"tours":     "<b>🗺️ Civitatis Buchungs-Assistent</b><br><br>Buchen Sie Ausflüge und Transfers direkt mit Ihrem Spree-Guthaben:<br><br>• <b>Automatische Buchung:</b> Ein Spree-Bot füllt das Buchungsformular für Sie aus.<br>• <b>Wie starten:</b> Schreiben Sie <b>'tour'</b> oder <b>'civitatis'</b> im Chat, oder tippen Sie auf den Bot-Button unter <b>'Reise Aufwerten'</b>.",
		"network":   "<b>🌐 Wie funktioniert Spree?</b><br><br>Spree rechnet Ihre USDc (digitale Dollar) bei QR-Zahlungen in Echtzeit zum besten Kurs in lokale Währung um, um den Händler sofort zu bezahlen.",
		...
		"times":     "<b>⏱️ Bearbeitungszeiten bei Spree</b><br><br>Die Dauer Ihrer Transaktionen im Überblick:<br><br>• <b>Aufladungen:</b> Sofort. Das Guthaben ist direkt verfügbar.<br>• <b>QR-Zahlungen (Mercado Pago, Pix):</b> Sofort. Der Händler erhält sein Geld direkt.<br>• <b>Erstattungen:</b> Dauern <b>2 bis 5 Werktage</b>, bis sie auf Ihrer Karte eingehen.",
	...
	case 4: // Esperando Email
		...
		return ChatResponse{
			Reply: fmt.Sprintf("¡Perfecto! Aquí tienes el resumen de tu reserva:\n"+
				...
				"- Correo: %s\n"+
				"- Precio: $%.2f USDc\n\n"+
				"Para confirmar la compra y realizar el cobro automático desde tus fondos Spree, responde 'SÍ' o 'OK' (o escribe 'cancelar' para salir).",
...
func handleSupportChat(w http.ResponseWriter, r *http.Request) {
	...
	if intent == "tours" {
		...
		reply := "¡Excelente! Con mi ayuda puedes reservar directamente actividades en Civitatis cobrando desde tus fondos de Spree. ¿En qué ciudad quieres realizar tu actividad? (Buenos Aires o Río de Janeiro)"
		if lang == "en" {
			reply = "Excellent! With my help you can book Civitatis activities directly, paying from your Spree balance. Which city do you want to book for? (Buenos Aires or Rio de Janeiro)"
		} else if lang == "it" {
			reply = "Eccellente! Con il mio aiuto puoi prenotare directamente le attività di Civitatis pagando dal tuo saldo Spree. In quale città vuoi prenotare? (Buenos Aires o Rio de Janeiro)"
		} else if lang == "fr" {
			reply = "Excellent ! Avec mon aide, vous pouvez réserver directement des activités Civitatis en payant depuis votre solde Spree. Pour quelle ville souhaitez-vous réserver ? (Buenos Aires ou Rio de Janeiro)"
		} else if lang == "de" {
			reply = "Hervorragend! Mit meiner Hilfe können Sie Civitatis-Aktivitäten direkt buchen und von Ihrem Spree-Guthaben bezahlen. Für welche Stadt möchten Sie buchen? (Buenos Aires oder Rio de Janeiro)"
		}
